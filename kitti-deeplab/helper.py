...
#19 semantic labels for cityscape
#road, sidewalk, building, fence, wall
#veget, terrain, car, bicycle, bus
#truck, train, motorcycle,sky, pole,
#traffic sign, traffic light, person, rider
