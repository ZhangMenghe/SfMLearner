...
flags.DEFINE_float("normal_weight", 0.1, "Weight for normal map smoothness")
flags.DEFINE_float("dnrefine_weight", 0.1, "Weight for depth/normal refinement constrain")
flags.DEFINE_float("edge_mask_weight", 0.5, "Weight for edge loss")
...
flags.DEFINE_boolean("background_only", False, "Use only background(static) for depth training")
flags.DEFINE_float("fore_weight", 0.0, "sepration of weight for foreground")
